...
public class TelegramBotConfiguration {
    ...
    public TelegramBot telegramBot() {
        ...
        bot.execute(new SetMyCommands(
                ...
                new BotCommand(Command.TAKE_A_DOG_COMMAND.getCommand(),
                        Command.TAKE_A_DOG_COMMAND.getDescription()),
                new BotCommand(Command.INTRODUCTION_TO_DOG_COMMAND.getCommand(),
                        Command.INTRODUCTION_TO_DOG_COMMAND.getDescription()),
                new BotCommand(Command.TAKE_DOCUMENTS_LIST_COMMAND.getCommand(),
                        Command.TAKE_DOCUMENTS_LIST_COMMAND.getDescription()),
                new BotCommand(Command.TRANSFER_A_DOG_COMMAND.getCommand(),
                        Command.TRANSFER_A_DOG_COMMAND.getDescription()),
                new BotCommand(Command.ENVIRONMENT_FOR_PUPPY_COMMAND.getCommand(),
                        Command.ENVIRONMENT_FOR_PUPPY_COMMAND.getDescription()),
                new BotCommand(Command.ENVIRONMENT_FOR_DOG_COMMAND.getCommand(),
                        Command.ENVIRONMENT_FOR_DOG_COMMAND.getDescription()),
                new BotCommand(Command.ENVIRONMENT_FOR_LIMITED_DOG_COMMAND.getCommand(),
                        Command.ENVIRONMENT_FOR_LIMITED_DOG_COMMAND.getDescription()),
                new BotCommand(Command.CYNOLOGIST_ADVICES_COMMAND.getCommand(),
                        Command.CYNOLOGIST_ADVICES_COMMAND.getDescription()),
                new BotCommand(Command.CYNOLOGIST_CONTACTS_COMMAND.getCommand(),
                        Command.CYNOLOGIST_CONTACTS_COMMAND.getDescription()),
